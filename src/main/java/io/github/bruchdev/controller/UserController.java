...
public interface UserController {
    ...
    /**
     * Revokes user subscription
     *
     * @param uuid    uuid of the user to revoke
     * @param request {@link RevokeUserSubscriptionRequest} request to revoke user subscription. If not provided, then a shortUUID will be generated by Remnawave. Remnawave recommends allowing it to generate shortUUID, so instead of this method pls use {@link #revokeUserSubscription(UUID)}.
     ...
     * @apiNote Although this method declares {@link RemnawaveException}, only the listed subclasses are thrown by this method.
     */
    Optional<UserResponse> revokeUserSubscription(@NonNull UUID uuid, @NonNull RevokeUserSubscriptionRequest request) throws RemnawaveException;

    /**
     * Revokes user subscription
     *
     * @see #revokeUserSubscription(UUID, RevokeUserSubscriptionRequest)
     */
